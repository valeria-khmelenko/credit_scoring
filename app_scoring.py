...
with st.sidebar:
    ...
    balance = st.slider('Введите долю остатка денежных средств на всех картах клиента по отношению к его кредитным лимитам', min_value=0.0, max_value=1.0, step=0.01)
